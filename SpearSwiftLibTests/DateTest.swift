...
class DateTest: XCTestCase {
    ...
    func testMDY() {
        let date = Date(timeIntervalSince1970: 1445077917)
	...
	func testAddDays() {
		let oct172015 = Date(timeIntervalSince1970: 1445077917)
	...
	func testIsSameDay() {
		let oct172015 = Date(timeIntervalSince1970: 1445077917)
		let laterThatSameDay = Date(timeIntervalSince1970: 1445114196)
